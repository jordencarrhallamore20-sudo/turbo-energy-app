      ...
      <div className="shell">
        ...
        <section className="panel reportPanel" id="report-generator">
          ...
          <div className="reportSectionSubTitle">Machine Availability Comparison</div>
                      ...
                      <div className="reportMiniTables">
                        <div>
                          <div className="reportSectionSubTitle">Availability by Machine Type</div>
                          <ReportGroupTable rows={reportTypeSummary} />
                        </div>
                        <div>
                          <div className="reportSectionSubTitle">Department Availability</div>
                          <ReportGroupTable rows={reportDepartmentSummary} />
                        </div>
                      </div>
        
                      <div className="reportSectionSubTitle">Department + Machine Type Availability</div>
                      <ReportGroupTable rows={reportDepartmentTypeSummary} />
